...
3. Running the Analysis
  ...
  - Load your data into a DataFrame named Africa.

  - Filter the years to focus on the 2000–2023 period.

  - Run the clustering script to generate the Elbow Plot.

  - Set optimal_k = 3 and execute the pipeline to generate the final cluster visualizations and membership tables.
